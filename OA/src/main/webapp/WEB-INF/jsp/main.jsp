...
<link href="${ctx}/res/css/platform.css" rel="stylesheet">
...
<script type="text/javascript" src="${ctx}/res/resources/main.js"></script>
...
<body>
    <div class="container">
        <div id="pf-hd">
           <div class="pf-logo">
                <img  src="${ctx}/res/images/main/main_logo.png" alt="logo">
           </div>
            ...
            <div class="pf-user">
                <div class="pf-user-photo">
                    <img style="width: 40px;height: 40px;" src="${ctx}/res/images/main/xiaoqiang.png" alt="">
                </div>
                <h4 class="pf-user-name ellipsis"><span id="username">${session_user.name}</span></h4>
                ...
                <div class="pf-user-panel">
                    <ul class="pf-user-opt">
                        <li>
                            <a href="javascript:;">
                                <i class="iconfont">&#xe60d;</i>
                                <span class="pf-opt-name">用户</span>
                            </a>
                        </li>
